...
// @Description  Unblock a company account
// @Tags         companies
// @Produce      json
...
// @Security     BearerAuth
// @Router       /companies/{id}/unblock [post]
func (h *Handler) Unblock(c *gin.Context) {
	...
	req := &companycommands.UnblockRequest{
		InitiatorID: initiatorID,
		CompanyID:   id,
	}

	_, err = h.commands.Unblock.Execute(c.Request.Context(), req)
	if err != nil {
