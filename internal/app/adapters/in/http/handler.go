...
import (
	...
	companycrthandler "time4book/internal/app/adapters/in/http/handlers/companyresourcetype"
...
type Handler struct {
	...
	CompanyResourceTypeHandler *companycrthandler.Handler
}
...
func NewHandler(
	...
	return &Handler{
		...
		CompanyResourceTypeHandler: companycrthandler.NewHandler(c.CompanyResourceType),
	}
}
